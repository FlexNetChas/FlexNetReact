...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ...
    ({ className, neon, size, variant = "default", children, asChild = false, ...props }, ref) => {
        ...
        return (
            ...
            >
                ...
                <span className={cn("absolute h-px opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out inset-x-0 inset-y-0 bg-gradient-to-r w-3/4 mx-auto from-transparent dark:via-blue-500 via-blue-600 to-transparent hidden", shouldShowNeon && "block")} />

                {children}

                <span className={cn("absolute group-hover:opacity-30 transition-all duration-500 ease-in-out inset-x-0 h-px -bottom-px bg-gradient-to-r w-3/4 mx-auto from-transparent dark:via-blue-500 via-blue-600 to-transparent hidden", shouldShowNeon && "block")} />
